# # ========== eval.py 第一行 追加所有阻塞兜底配置 ==========
# import os
# import torch
# import time
# # 1. AirSim渲染+超时兜底（核心）
# os.environ['PYOPENGL_PLATFORM'] = 'osmesa'
# os.environ['AIRSIM_IMAGE_TIMEOUT'] = '5'
# os.environ['SDL_VIDEODRIVER'] = 'dummy'
# os.environ['QT_QPA_PLATFORM'] = 'offscreen'
# # 2. CUDA显存+算子兜底（解决推理阻塞）
# os.environ['CUDA_LAUNCH_BLOCKING'] = '0'
# os.environ['PYTORCH_CUDA_ALLOC_CONF'] = 'max_split_size_mb:128'
# torch.backends.cudnn.benchmark = True  # 加速CUDA kernel编译
# torch.backends.cudnn.enabled = True
# # 3. 模型兜底（禁用flash-attn+限制线程）
# os.environ['DISABLE_FLASH_ATTN'] = '1'
# os.environ['OMP_NUM_THREADS'] = '4'
# os.environ['TOKENIZERS_PARALLELISM'] = 'false'
# print("✅ 已加载所有卡死兜底配置，AirSim/CUDA/模型阻塞已解除")
...
def main():
    eval_info = "/mnt/geogpt-doc-new/default/cx/UAV/OpenFly/train_t2rl_lora/data/t2rl_eval_with_translated.json"
    ...
    # Load model
    model_name_or_path="./model/openfly-agent"
