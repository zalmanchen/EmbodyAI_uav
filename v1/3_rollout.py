...
def main():
    ...
    parser.add_argument("--input", type=str, default="/home/cx/Desktop/UAV/OpenFly/train_t2rl_lora/data/t2rl_train_k100_n3_with_translated.json", 
                        help="输入日志路径 (e.g., logs_train_k5_n3.json)")
    parser.add_argument("--output", type=str, default="./t2rl/data/rollout_with_trajectory_k100_n3.json",
                        help="输出带轨迹的日志路径")
